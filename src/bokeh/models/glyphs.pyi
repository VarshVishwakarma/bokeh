...
class _ArrowGlyphInit(_SegmentInit, total=False):
    start: ArrowHead | None
    end: ArrowHead | None

class ArrowGlyph(Segment):
    def __init__(self, **kwargs: Unpack[_ArrowGlyphInit]) -> None: ...

    start: ArrowHead | None = ...
    end: ArrowHead | None = ...

class _BandGlyphInit(_GlyphInit, _ScalarLinePropsInit, _ScalarFillPropsInit, _ScalarHatchPropsInit):
    dimension: Dimension
    lower: NumberSpec
    upper: NumberSpec
    base: NumberSpec
...
class BandGlyph(Glyph, ScalarLineProps, ScalarFillProps, ScalarHatchProps):
    def __init__(self, **kwargs: Unpack[_BandGlyphInit]) -> None: ...
...
class _WhiskerGlyphInit(_GlyphInit, _LinePropsInit):
    dimension: Dimension
    lower: NumberSpec
    upper: NumberSpec
    base: NumberSpec
...
class WhiskerGlyph(Glyph, LineProps):
    def __init__(self, **kwargs: Unpack[_WhiskerGlyphInit]) -> None: ...
